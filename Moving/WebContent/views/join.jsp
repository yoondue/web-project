				...
				<div class="col-md-6">
					...
					<div class="row box1">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id="pw" placeholder="패스워드는 8자 이상, 영문/특수문자 포함">
						</div>
						<div class="form-group">
							<label for="pw2">패스워드 확인</label> 
							<input type="password" class="form-control" id="pw2" placeholder="패스워드는 8자 이상, 영문/특수문자 포함">
						</div>

						<label for="nickname">닉네임</label>
						<div class="form-group">
							<input type="text" class="form-control" id="nickname" placeholder="특수문자 불가">
							<button type="submit" class="btn btn-secondary">중복확인</button>
						</div>

						<div>
							<br>영화 맞춤 추천 시 사용되어집니다!<br>
						...
						<div>
							<br>
							<label>내가 좋아하는 영화장르 (추천 영화 제공, 최대 3개까지 선택 가능)</label><br>
							<br>

							<div class="check">
								<div class="genre">
									<label class="image" for="action"> <img src="/Moving/images/genre/action.png"></label> 
									<input type="checkbox" name="check" id="action" value="action"><span>액션</span>
								</div>

								<div class="genre">
									<label class="image" for="animation"> <img src="/Moving/images/genre/animation.png"></label> 
									<input type="checkbox" name="check" id="animation" value="animation"><span>애니메이션</span>
								</div>
								<div class="genre">
									<label class="image" for="comedy"><img src="/Moving/images/genre/comedy.png"></label> 
									<input type="checkbox" name="check" id="comedy" value="comedy"><span>코미디</span>
								</div>
								<div class="genre">
